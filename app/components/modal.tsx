            ...
            {isOpen && (
                <div className="fixed z-10 inset-0 overflow-y-auto flex items-center justify-center">
                    ...
                    <div className="bg-white  rounded-xl text-center overflow-hidden shadow-xl transform transition-all w-5/6 sm:w-2/3 md:w-1/2 lg:w-1/3 p-10 m-6 lg:m-0  flex flex-col relative">
                        ...
                        <a href="mailto:ttngo@andrew.cmu.edu" className="w-full flex justify-center items-center rounded-xl border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mb-4">
